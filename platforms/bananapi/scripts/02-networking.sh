#!/bin/bash
# =============================================================================
# BananaPi networking — Armbian base, DHCP on eth0/end0, no AP
# =============================================================================
# Armbian may ship with NetworkManager — we switch to systemd-networkd
# for consistency with other CubeOS platforms. No WiFi AP on BananaPi M5
# (no onboard WiFi), so this is wired-only like x86_64.
# =============================================================================
set -euo pipefail
echo "=== [02] Network Configuration (BananaPi/Armbian) ==="
...
echo "=== [02] BananaPi Network Configuration: DONE ==="
