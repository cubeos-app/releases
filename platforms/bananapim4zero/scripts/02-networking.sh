#!/bin/bash
# =============================================================================
# BPI-M4 Zero networking — Armbian base, DHCP on eth0/end0, no AP (yet)
# =============================================================================
# Armbian may ship with NetworkManager — we switch to systemd-networkd
# for consistency with other CubeOS platforms.
#
# NOTE: BPI-M4 Zero has built-in WiFi (RTL8821CS or similar) — AP mode
# support can be added later using hostapd, similar to Raspberry Pi.
...
echo "=== [02] BPI-M4 Zero Network Configuration: DONE ==="
