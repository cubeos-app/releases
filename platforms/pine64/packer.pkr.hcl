# =============================================================================
# CubeOS Pine64 Release Image Builder — v0.2.0-beta.01
# =============================================================================
# Builds a flashable ARM64 image for Pine64 using Armbian as base OS.
#
...
#   - No WiFi AP (Pine64 has no reliable onboard WiFi)
#
...
#
# TODO: Verify base image URL at https://www.armbian.com/pine64/
# TODO: Verify partition start sector matches Armbian image layout
# TODO: Test on real Pine64 hardware
# =============================================================================
...
variable "base_image_url" {
  type    = string
  default = "https://dl.armbian.com/pine64/archive/Armbian_community_25.2.0-trunk.344_Pine64_noble_current_6.12.8.img.xz"
  # TODO: Check https://www.armbian.com/pine64/ for latest stable image
}
...
source "arm" "cubeos-pine64" {
  ...
  image_path         = var.variant == "lite" ? "cubeos-${var.version}-lite-pine64-arm64.img" : "cubeos-${var.version}-pine64-arm64.img"
...
build {
  sources = ["source.arm.cubeos-pine64"]

  # Phase 1: Armbian networking (no hostapd — Pine64 has no reliable onboard WiFi)
  provisioner "shell" {
    script = "platforms/pine64/scripts/02-networking.sh"
  }
  ...
  provisioner "shell" {
    ...
    scripts = [
      ...
      "platforms/pine64/scripts/09-board-config.sh",
