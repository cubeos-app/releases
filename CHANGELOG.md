...
## v0.2.0-beta.06 — 2026-03-20

### API

- add MeshSat coreapp integration — proxy routes, port reservation, system app seed ([630bd3bb](https://github.com/cubeos-app/api/commit/630bd3bb))
- add MeshSat Phase 2 proxy routes for admin, config, waypoints ([ca53b540](https://github.com/cubeos-app/api/commit/ca53b540))
- add MeshSat gateway proxy routes for MQTT and Iridium management ([37d9a881](https://github.com/cubeos-app/api/commit/37d9a881))
- add mosquitto to registry sync engine ([feeb8ddc](https://github.com/cubeos-app/api/commit/feeb8ddc))
- proxy /communication/iridium/signal/fast to HAL fast endpoint ([0acd5b88](https://github.com/cubeos-app/api/commit/0acd5b88))
- Iridium operational dashboard — schema v25 + signal history + credits ([68888128](https://github.com/cubeos-app/api/commit/68888128))
- Iridium pass predictor + queue proxy (Priorities 3d + 4) ([96675a9d](https://github.com/cubeos-app/api/commit/96675a9d))
- Phase 12 — TLS manager, managed interface, schema v27 ([c5ede582](https://github.com/cubeos-app/api/commit/c5ede582))
- TLS certificate management API endpoints ([d65e1468](https://github.com/cubeos-app/api/commit/d65e1468))
- self-healing NPM auth when Swarm env var has stale password ([2947c96b](https://github.com/cubeos-app/api/commit/2947c96b))
- skip Pi-hole DHCP/DNS verification on container tier (LXC/VM) ([390042b1](https://github.com/cubeos-app/api/commit/390042b1))
- strip CIDR prefix from Ethernet IP in setup wizard status ([c792ea48](https://github.com/cubeos-app/api/commit/c792ea48))
- use port-only URL for standard profile app install SSE event ([e211bed6](https://github.com/cubeos-app/api/commit/e211bed6))
- parse embedded tag from image ref to prevent double-tagging ([535c3178](https://github.com/cubeos-app/api/commit/535c3178))
- replace hardcoded gateway IPs with models.DefaultGatewayIP and route Pi-hole recreate through HAL ([6028c53c](https://github.com/cubeos-app/api/commit/6028c53c))
- URL-decode Bluetooth MAC address path params before forwarding to HAL ([452683ec](https://github.com/cubeos-app/api/commit/452683ec))
- wait for Swarm convergence before health-checking in deploy script ([3135312f](https://github.com/cubeos-app/api/commit/3135312f))
- use docker_gwbridge gateway for NPM, Pi-hole, Ollama, ChromaDB URLs ([ec6a0320](https://github.com/cubeos-app/api/commit/ec6a0320))
- CI dual-IP failover + wifi_client netplan dhcp-identifier: mac ([d771bd64](https://github.com/cubeos-app/api/commit/d771bd64))
- ci-deploy.sh sources env files for compose variable substitution ([efb9d8bb](https://github.com/cubeos-app/api/commit/efb9d8bb))
- add dhcp-identifier: mac to wifi_bridge wlan1 DHCP config ([4669f7f7](https://github.com/cubeos-app/api/commit/4669f7f7))
- use saved PSK from HAL for wifi_client netplan generation ([79f8c697](https://github.com/cubeos-app/api/commit/79f8c697))
- use wlan0 as upstream interface in wifi_client GetStatus ([789df742](https://github.com/cubeos-app/api/commit/789df742))
- compare image digests in deploy skip check, not tag names ([8cf552f9](https://github.com/cubeos-app/api/commit/8cf552f9))
- correct Celestrak TLE URL to gp.php query endpoint ([300a1c9f](https://github.com/cubeos-app/api/commit/300a1c9f))
- update mock ProxyManager for CreateProxyHostWithTLS interface ([ad63c741](https://github.com/cubeos-app/api/commit/ad63c741))
- **api**: parallelize internet connectivity checks in GetNetworkStatus [CUBEOS-44] ([a37bacbe](https://github.com/cubeos-app/api/commit/a37bacbe))
- **api**: reduce connectivity check timeout to 1.5s [CUBEOS-44] ([4ae73bc9](https://github.com/cubeos-app/api/commit/4ae73bc9))
- add consistency gate to lint stage [CUBEOS-44] ([d951363b](https://github.com/cubeos-app/api/commit/d951363b))
- fix consistency gate false positives [CUBEOS-44] ([9d3321a7](https://github.com/cubeos-app/api/commit/9d3321a7))
- exclude CI YAML from consistency diff to prevent false positives [CUBEOS-44] ([7e28635e](https://github.com/cubeos-app/api/commit/7e28635e))
- add Docker Hub auth to buildx package stage [CUBEOS-67] ([7413b486](https://github.com/cubeos-app/api/commit/7413b486))

### Dashboard

- MeshSat Phase 3 — telemetry charts, map, and sub-tab UI ([841be786](https://github.com/cubeos-app/dashboard/commit/841be786))
- add MeshSat gateway management to communication store and config UI ([b6c43fd2](https://github.com/cubeos-app/dashboard/commit/b6c43fd2))
- Iridium 10s fast signal poll + manual blocking refresh button ([0d4c8167](https://github.com/cubeos-app/dashboard/commit/0d4c8167))
- Iridium operational dashboard — signal history, credits, diagnostics ([b9ea8fac](https://github.com/cubeos-app/dashboard/commit/b9ea8fac))
- Iridium queue UI + pass predictor card (Priorities 3d + 4) ([811d4da2](https://github.com/cubeos-app/dashboard/commit/811d4da2))
- Phase 12 — wizard interface/TLS steps, settings CA download ([0ad0775f](https://github.com/cubeos-app/dashboard/commit/0ad0775f))
- TLS certificate management UI in Apps > Manager ([e49cc1bb](https://github.com/cubeos-app/dashboard/commit/e49cc1bb))
- resolve port-only app URLs using current hostname ([aef9e3f7](https://github.com/cubeos-app/dashboard/commit/aef9e3f7))
- split cached image into name and tag for offline installs ([e1665868](https://github.com/cubeos-app/dashboard/commit/e1665868))
- reorder Communication page tabs — Bluetooth first in both modes ([52791822](https://github.com/cubeos-app/dashboard/commit/52791822))
- split Bluetooth devices into separate Paired and Available sections ([cdf9c812](https://github.com/cubeos-app/dashboard/commit/cdf9c812))
- auto-scroll to WiFi password field after network selection ([ab306abe](https://github.com/cubeos-app/dashboard/commit/ab306abe))
- CI dual-IP failover for deploy target resolution ([22e494f8](https://github.com/cubeos-app/dashboard/commit/22e494f8))
- ci-deploy.sh sources env files for compose variable substitution ([0efe0836](https://github.com/cubeos-app/dashboard/commit/0efe0836))
- add consistency gate to validate stage [CUBEOS-44] ([5234c84f](https://github.com/cubeos-app/dashboard/commit/5234c84f))
- exclude CI YAML from consistency diff to prevent false positives [CUBEOS-44] ([3c276ef1](https://github.com/cubeos-app/dashboard/commit/3c276ef1))
- add Docker Hub auth to buildx package stage [CUBEOS-67] ([12fd1067](https://github.com/cubeos-app/dashboard/commit/12fd1067))

### HAL

- add POST /system/service/{name}/recreate for Docker Compose service recreation ([28417825](https://github.com/cubeos-app/hal/commit/28417825))
- add Meshtastic admin commands, radio/module config, waypoints, signal quality ([747fdb5e](https://github.com/cubeos-app/hal/commit/747fdb5e))
- raw AT command endpoint + Iridium SSE keepalive ([c9fa745e](https://github.com/cubeos-app/hal/commit/c9fa745e))
- add GET /iridium/signal/fast endpoint (AT+CSQF cached read) ([62db7ec7](https://github.com/cubeos-app/hal/commit/62db7ec7))
- add signal quality poller to Iridium driver ([a47da8dd](https://github.com/cubeos-app/hal/commit/a47da8dd))
- Phase 12 — UPS persistence, Ethernet DHCP capability ([56480599](https://github.com/cubeos-app/hal/commit/56480599))
- add Device Supervisor for universal USB device management ([15ad8103](https://github.com/cubeos-app/hal/commit/15ad8103))
- add AdminRemoveNode endpoint for node deletion ([f66b59b2](https://github.com/cubeos-app/hal/commit/f66b59b2))
- add HAL_DISABLE_MESHTASTIC and HAL_DISABLE_IRIDIUM env vars ([d21bd7c0](https://github.com/cubeos-app/hal/commit/d21bd7c0))
- GetInterface returns structured JSON matching ListInterfaces format ([a14034cb](https://github.com/cubeos-app/hal/commit/a14034cb))
- restore ip_forward after netplan apply ([b84555b6](https://github.com/cubeos-app/hal/commit/b84555b6))
- restore Docker masquerade rules after netplan apply ([4bbf05a0](https://github.com/cubeos-app/hal/commit/4bbf05a0))
- detect docker_gwbridge subnet dynamically in restoreDockerNetworking ([29d8fa8c](https://github.com/cubeos-app/hal/commit/29d8fa8c))
- auto-start bluetooth.service when HCI hardware is present but bluetoothd not running ([d8204b8e](https://github.com/cubeos-app/hal/commit/d8204b8e))
- add bluez to Dockerfile and use nsenter for host commands ([fa79b1ea](https://github.com/cubeos-app/hal/commit/fa79b1ea))
- return discovered Bluetooth devices from GetBluetoothDevices ([7b0f1363](https://github.com/cubeos-app/hal/commit/7b0f1363))
- CI dual-IP failover for deploy target resolution ([9e7ef3de](https://github.com/cubeos-app/hal/commit/9e7ef3de))
- ci-deploy.sh sources env files for compose variable substitution ([52d811ef](https://github.com/cubeos-app/hal/commit/52d811ef))
- Iridium signal — increase AT+CSQ timeout, add AT+CSQF fast path ([174f637e](https://github.com/cubeos-app/hal/commit/174f637e))
- HAL deploy — atomic recreate + WiFi preservation ([9bf63cdb](https://github.com/cubeos-app/hal/commit/9bf63cdb))
- HAL deploy survives WiFi disruption ([86852167](https://github.com/cubeos-app/hal/commit/86852167))
- serial transport — persist read buffer across RecvFromRadio calls ([cf9e12c6](https://github.com/cubeos-app/hal/commit/cf9e12c6))
- correct FromRadio protobuf field numbers to match Meshtastic spec ([13d4c39c](https://github.com/cubeos-app/hal/commit/13d4c39c))
- MeshPacket parser — from/to/id are fixed32, not varint ([76f49030](https://github.com/cubeos-app/hal/commit/76f49030))
- serial read deadline prevents file.Read() from blocking forever ([70128ce5](https://github.com/cubeos-app/hal/commit/70128ce5))
- serial reliability — HUPCL, heartbeat, Iridium spec compliance ([5bb12d1b](https://github.com/cubeos-app/hal/commit/5bb12d1b))
- SSE stream — disable WriteTimeout and add keepalive ([aa05449f](https://github.com/cubeos-app/hal/commit/aa05449f))
- MeshPacket send — encode from/to as fixed32, not varint ([99c3b4cf](https://github.com/cubeos-app/hal/commit/99c3b4cf))
- return saved PSK in ConnectWiFi response for netplan generation ([47ef28ae](https://github.com/cubeos-app/hal/commit/47ef28ae))
- pull by commit SHA and add digest-based skip check in deploy ([79d05e12](https://github.com/cubeos-app/hal/commit/79d05e12))
- add Docker network routes to policy routing table 100 ([97f302ef](https://github.com/cubeos-app/hal/commit/97f302ef))
- complete three-layer routing fix for dual-interface wifi_client ([8753186f](https://github.com/cubeos-app/hal/commit/8753186f))
- eliminate serial read race in Iridium driver ([c6fd7949](https://github.com/cubeos-app/hal/commit/c6fd7949))
- increase AT+CSQ and HTTP timeouts for Iridium signal acquisition ([34b775e5](https://github.com/cubeos-app/hal/commit/34b775e5))
- add TTGO T-Echo VID:PID (239a:4405) to Meshtastic device table ([030b9bc4](https://github.com/cubeos-app/hal/commit/030b9bc4))
- return hw_model as int in /meshtastic/status (was sending string) ([16c0258d](https://github.com/cubeos-app/hal/commit/16c0258d))
- prevent empty SBDIX sessions wasting Iridium credits ([4aeed649](https://github.com/cubeos-app/hal/commit/4aeed649))
- handle piggybacked MT delivery + log SBDIX results for debugging ([a6facf68](https://github.com/cubeos-app/hal/commit/a6facf68))
- stop consuming MT buffer in send/mailbox handlers ([3e45218c](https://github.com/cubeos-app/hal/commit/3e45218c))
- ReadBinaryMT read loop exits too early + receive fallback ([2cbf1043](https://github.com/cubeos-app/hal/commit/2cbf1043))
- remove SBDSX RA-gate that blocked all SBDIX sessions ([a325647c](https://github.com/cubeos-app/hal/commit/a325647c))
- restore SBDIX conditional gate + release mutex during rate-limit wait ([762aac02](https://github.com/cubeos-app/hal/commit/762aac02))
- add 5-minute stale SBDIX fallback for missed ring alerts ([388c0788](https://github.com/cubeos-app/hal/commit/388c0788))
- clear MT buffer after successful read to prevent stale MTFlag loop ([8db5c9d6](https://github.com/cubeos-app/hal/commit/8db5c9d6))
- remove stale SBDIX check that sent empty SBD messages every 15min ([c4d01b0a](https://github.com/cubeos-app/hal/commit/c4d01b0a))
- add serial protocol tracing to diagnose packet flow ([13870595](https://github.com/cubeos-app/hal/commit/13870595))
- add consistency gate to validate stage [CUBEOS-44] ([35f00301](https://github.com/cubeos-app/hal/commit/35f00301))
- exclude CI YAML from consistency diff to prevent false positives [CUBEOS-44] ([c56b40c3](https://github.com/cubeos-app/hal/commit/c56b40c3))
- add Docker Hub auth to buildx package stage [CUBEOS-67] ([8d1e678c](https://github.com/cubeos-app/hal/commit/8d1e678c))

### Core Apps

- add MeshSat coreapp deployment config ([14bc7aa6](https://github.com/cubeos-app/coreapps/commit/14bc7aa6))
- add Mosquitto MQTT broker coreapp for MeshSat gateway bridge ([5d645cb7](https://github.com/cubeos-app/coreapps/commit/5d645cb7))
- HAL disable flags + MeshSat direct-mode compose ([44cde849](https://github.com/cubeos-app/coreapps/commit/44cde849))
- make appdata mkdir non-fatal in ci-deploy script ([3f9a0a94](https://github.com/cubeos-app/coreapps/commit/3f9a0a94))
- make per-app config sync resilient to root-owned directories ([179988d6](https://github.com/cubeos-app/coreapps/commit/179988d6))
- classify mosquitto and meshsat as swarm stacks in CI ([9b175909](https://github.com/cubeos-app/coreapps/commit/9b175909))
- automate mosquitto config deployment and image lifecycle ([bef02a90](https://github.com/cubeos-app/coreapps/commit/bef02a90))
- dashboard uses detected docker_gwbridge gateway instead of GATEWAY_IP ([4740be64](https://github.com/cubeos-app/coreapps/commit/4740be64))
- API uses detected docker_gwbridge gateway for HAL_URL ([69407154](https://github.com/cubeos-app/coreapps/commit/69407154))
- MeshSat uses docker_gwbridge gateway for HAL_URL ([1f1cee46](https://github.com/cubeos-app/coreapps/commit/1f1cee46))
- pass HAL_API_KEY to MeshSat container for authenticated HAL access ([5467a363](https://github.com/cubeos-app/coreapps/commit/5467a363))
- CI dual-IP failover for deploy target resolution ([2f00a665](https://github.com/cubeos-app/coreapps/commit/2f00a665))
- ci-restart.sh sources secrets.env for compose variable substitution ([3f5f4a0c](https://github.com/cubeos-app/coreapps/commit/3f5f4a0c))
- MeshSat HAL_URL needs /hal prefix for correct endpoint paths ([fbf2622c](https://github.com/cubeos-app/coreapps/commit/fbf2622c))
- remove HAL_API_KEY from meshsat compose environment ([0aa5a6a0](https://github.com/cubeos-app/coreapps/commit/0aa5a6a0))
- MeshSat direct compose uses host network mode ([443e2085](https://github.com/cubeos-app/coreapps/commit/443e2085))
- add consistency gate to validate stage [CUBEOS-44] ([658fdc80](https://github.com/cubeos-app/coreapps/commit/658fdc80))
- exclude CI YAML from consistency diff to prevent false positives [CUBEOS-44] ([15a80a1d](https://github.com/cubeos-app/coreapps/commit/15a80a1d))

### Releases

- add mosquitto to build-time image baking ([092544b7](https://github.com/cubeos-app/releases/commit/092544b7))
- detect docker_gwbridge gateway at boot and deploy time ([dcaecd39](https://github.com/cubeos-app/releases/commit/dcaecd39))
- Phase 12 — Ethernet DHCP enforcement, CA generation on boot ([44401d11](https://github.com/cubeos-app/releases/commit/44401d11))
- **bananapim4zero**: pin Armbian 26.2.1 base image, enable CI builds [CUBEOS-74] ([51d1ebdb](https://github.com/cubeos-app/releases/commit/51d1ebdb))
- **bananapim4zero**: golden base + full networking + CI pipeline [CUBEOS-74] ([09c258b1](https://github.com/cubeos-app/releases/commit/09c258b1))
- **ci**: add BananaPi BPI-M4 Zero to release pipeline [CUBEOS-74] ([4cfbd3e7](https://github.com/cubeos-app/releases/commit/4cfbd3e7))
- harden upload-to-dmz and changelog generation ([8a73713a](https://github.com/cubeos-app/releases/commit/8a73713a))
- enable/disable bluetooth.service alongside rfkill in coexistence check ([5951cd29](https://github.com/cubeos-app/releases/commit/5951cd29))
- wifi_client netplan adds eth0 with dhcp-identifier: mac ([109a74d3](https://github.com/cubeos-app/releases/commit/109a74d3))
- add dhcp-identifier: mac to wifi_bridge wlan1 DHCP config ([f95aa049](https://github.com/cubeos-app/releases/commit/f95aa049))
- update changelog for v0.2.0-beta.05 ([8bdccc95](https://github.com/cubeos-app/releases/commit/8bdccc95))
- add consistency gate to lint stage [CUBEOS-44] ([a468a3b8](https://github.com/cubeos-app/releases/commit/a468a3b8))
- fix needs:optional for validate-image and sync-installer [CUBEOS-44] ([b87bda10](https://github.com/cubeos-app/releases/commit/b87bda10))
- exclude CI YAML from consistency diff to prevent false positives [CUBEOS-44] ([50e7e46e](https://github.com/cubeos-app/releases/commit/50e7e46e))
- restrict validate-image rules to match build-image triggers [CUBEOS-44] ([ba3ba02c](https://github.com/cubeos-app/releases/commit/ba3ba02c))
